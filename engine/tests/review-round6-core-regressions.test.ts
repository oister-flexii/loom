...
/** Transcript defects short-circuit before this unavailable projection can refuse settlement. */
const UNAVAILABLE_FLOOR = unprojectedFloor("test fixture: no projection");
...
describe("round-six evidence authority regressions", () => {
  it.each([
    ...
    const resolution = reconcileSpecCheck(parsed, 2, "2026-08-31T00:00:00.000Z", UNAVAILABLE_FLOOR);
